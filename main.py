...
from app.db_actions import getZkrPackList, getZkrList, getZkrStrList, getZkrPack, insertZkrPack, getZkrInfo, getStrInfo
...
@myapi.get('/zrst_info/{str_id}')
def showStrInfo(str_id):
    return getStrInfo(db_path, str_id)
